...
var MetaRegistry = MetaRegistryType{
	"A": {
		...
		Domein:                 "abuvwxy",
		Kleur:                  "#bfdbfe",
		Layout:                 &EditorLayout{Positie: &V3Positie{X: -740, Y: 65}},
		Veldnaam:               "a",
		Padnaam:                "as",
		Meervoud:               "as",
		...
		AfgeleideVelden: []AfgeleidVeld{
			{
				...
				Afleidingsregel:     "U.aaa + (U.bbb != null ? ' [bbb=ja]' : '') + (W.heel != null ? ' ┬À heel=' + W.heel : '')",
				IsWeergaveVeld:      true,
			},
		},
	},
	"A_U": {
		...
		Layout: &EditorLayout{
			Positie: &V3Positie{X: -900, Y: 405}, EdgeID: "A->A_U",
		},
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
	...
	"A_V": {
		...
		Layout: &EditorLayout{
			Positie: &V3Positie{X: -675, Y: 390}, EdgeID: "A->A_V",
		},
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
	...
	"A_W": {
		...
		Momentvoorkomen:        Meervoudig,
		Layout: &EditorLayout{
			Positie: &V3Positie{X: -450, Y: 405}, EdgeID: "A->A_W",
		},
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
	...
	"Rel_A_B": {
		...
		Momentvoorkomen:           Meervoudig,
		Layout: &EditorLayout{
			Positie: &V3Positie{X: -330, Y: 60}, EdgeID: "A->Rel_A_B",
	...
	"B": {
		...
		Domein:                 "abuvwxy",
		Kleur:                  "#fecaca",
		Layout:                 &EditorLayout{Positie: &V3Positie{X: 15, Y: 75}},
		Veldnaam:               "b",
		Padnaam:                "bs",
		Meervoud:               "bs",
	...
	"B_X": {
		...
		Momentvoorkomen:        Enkelvoudig,
		Layout: &EditorLayout{
			Positie: &V3Positie{X: -75, Y: 300}, EdgeID: "B->B_X",
		},
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
	...
	"B_Y": {
		...
		Momentvoorkomen:        Enkelvoudig,
		Layout: &EditorLayout{
			Positie: &V3Positie{X: 150, Y: 315}, EdgeID: "B->B_Y",
		},
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
