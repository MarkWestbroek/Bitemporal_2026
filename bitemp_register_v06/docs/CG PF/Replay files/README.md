...
| 21 | `registraties-replay-init-querydefinitie-nieuwe-aanmeldingen-2026-09-25.json` | platform | 10, 11: QueryDefinitie 3 `nieuwe-aanmeldingen` (**intern**): de modereerlijst — initiatieven met status `nieuwe_aanmelding` of `in_behandeling`. Uitvoeren: `POST /graphql/query {"documentId":"nieuwe-aanmeldingen"}` als ingelogde gebruiker (minimaal viewer). Basis voor de latere DashboardDefinitie-tegel en de notificatie-inhoud |
