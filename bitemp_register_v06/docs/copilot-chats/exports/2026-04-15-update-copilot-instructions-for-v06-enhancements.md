...
Let me gather context about the current v06 state from multiple sources. Now let me read the v06-active instructions for completeness: Now I have full context. Let me draft the updated copilot-instructions.md. The current file is Now I have full context. Let me draft the updated copilot-instructions.md. The current file is v05-focused; I'll rewrite it to reflect the v06 reality while keeping v05 as reference. 
```
...
```
Het bestand  is volledig herschreven. Dit zijn de belangrijkste wijzigingen ten opzichte van de oude v05-versie:
