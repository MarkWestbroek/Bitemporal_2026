...
const MENU_ITEMS = {
  ...
  separatorB: { separator: true },
  castNaarGE: { label: "🔄 Cast entiteit naar gegevenselement…", types: ["entiteit"] },
  splitsEntiteit: { label: "✂️ Splits velden uit naar GE's…", types: ["entiteit"] },
  separator0: { separator: true },
  toonInDiagram: { label: "📍 Toon op diagram", types: ["entiteit", "gegevenselement", "relatie", "enumeratie", "gegevenstype", "referentielijstInstantie", "notitie", "constraint"] },
  toonDetails: { label: "ℹ️ Toon details", types: ["entiteit", "gegevenselement", "relatie", "enumeratie", "gegevenstype", "referentielijstInstantie", "notitie", "constraint"] },
  ...
  verwijder: { label: "🗑️ Verwijder uit model", types: ["entiteit", "gegevenselement", "relatie", "enumeratie", "gegevenstype", "referentielijstInstantie", "notitie", "constraint"] },
