...
- Totale grootte: `11 MB` (`11,957,951 bytes`)

### Grootste tabellen (met exacte rows voor top-tabellen)

| tabel | exact_rows | total_size |
|---|---:|---:|
| wijziging | 14560 | 1472 kB |
| a_v | 7280 | 728 kB |
| a_u | 3640 | 424 kB |
| registratie | 3640 | 416 kB |
| a | 3640 | 304 kB |
| tests | 0 | 16 kB |
| b_y | 0 | 16 kB |
| b_x | 0 | 16 kB |
...
Groei zit vooral in `wijziging`, `a_v`, `a_u`, `registratie` en `a`, wat past bij je registratie/performance-runs.
