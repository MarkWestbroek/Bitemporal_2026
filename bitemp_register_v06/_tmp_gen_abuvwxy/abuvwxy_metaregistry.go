...
func initAbuvwxyMetaRegistry() {
	MetaRegistry["A"] = TypeMeta{
		...
		Domein:                 "abuvwxy",
		Kleur:                  "#bfdbfe",
		Layout:                 &EditorLayout{Positie: &V3Positie{X: -740, Y: 170}},
		Veldnaam:               "a",
		Padnaam:                "as",
		Meervoud:               "as",
	...
	MetaRegistry["A_U"] = TypeMeta{
		...
		Layout: &EditorLayout{
			Positie: &V3Positie{X: -900, Y: 510}, EdgeID: "A->A_U",
		},
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
	...
	MetaRegistry["A_V"] = TypeMeta{
		...
		Layout: &EditorLayout{
			Positie: &V3Positie{X: -675, Y: 495}, EdgeID: "A->A_V",
		},
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
	...
	MetaRegistry["A_W"] = TypeMeta{
		...
		Momentvoorkomen:        Meervoudig,
		Layout: &EditorLayout{
			Positie: &V3Positie{X: -450, Y: 510}, EdgeID: "A->A_W",
		},
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
	...
	MetaRegistry["Rel_A_B"] = TypeMeta{
		...
		Momentvoorkomen:           Meervoudig,
		Layout: &EditorLayout{
			Positie: &V3Positie{X: -330, Y: 165}, EdgeID: "A->Rel_A_B",
	...
	MetaRegistry["B"] = TypeMeta{
		...
		Domein:                 "abuvwxy",
		Kleur:                  "#fecaca",
		Layout:                 &EditorLayout{Positie: &V3Positie{X: 15, Y: 180}},
		Veldnaam:               "b",
		Padnaam:                "bs",
		Meervoud:               "bs",
	...
	MetaRegistry["B_X"] = TypeMeta{
		...
		Momentvoorkomen:        Enkelvoudig,
		Layout: &EditorLayout{
			Positie: &V3Positie{X: -75, Y: 405}, EdgeID: "B->B_X",
		},
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
	...
	MetaRegistry["B_Y"] = TypeMeta{
		...
		Momentvoorkomen:        Enkelvoudig,
		Layout: &EditorLayout{
			Positie: &V3Positie{X: 150, Y: 420}, EdgeID: "B->B_Y",
		},
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
