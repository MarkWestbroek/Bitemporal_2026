...
func initAbuvwxyMetaRegistry() {
	MetaRegistry["A"] = TypeMeta{
		...
		Domein:                 "abuvwxy",
		Kleur:                  "#bfdbfe",
		Layout:                 &EditorLayout{Positie: &V3Positie{X: -495, Y: 90}},
		Veldnaam:               "a",
		Padnaam:                "as",
		Meervoud:               "as",
	...
	MetaRegistry["Rel_A_B"] = TypeMeta{
		...
		Layout: &EditorLayout{
			...
			AnkerPositie:          &V3Positie{X: -45, Y: 120},
			ClassLinkEdgeID:       "anker_Rel_A_B-->Rel_A_B",
	...
	MetaRegistry["B"] = TypeMeta{
		...
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
			...
			{Rolnaam: "Bc", JSONRolnaam: "bc", Doeltype: "B_BC", Momentvoorkomen: Meervoudig},
	...
	MetaRegistry["B_BC"] = TypeMeta{
		...
		Domein:                    "abuvwxy",
		GESubtype:                 GESubtypeHub,
		DataTypenaam:              "B_BC_Data",
		Kleur:                     "",
		Veldnaam:                  "b_bc",
		Padnaam:                   "bc",
		Meervoud:                  "bc",
		Factory:                   func() Representatie { return &B_BC_Input{} },
		Tabelnaam:                 "b_bc",
		IDKolom:                   "rel_id",
		DBFactory:                 func() Representatie { return &B_BC{} },
		DBSliceFactory:            func() any { return &[]B_BC{} },
		HeeftPFK:                  true,
		RelatieveAutoincrement:    true,
		EntiteitIDKolom:           "b_id",
		SecondaireEntiteitIDKolom: "c_id",
		Momentvoorkomen:           Meervoudig,
		Directioneel:              true,
		Layout: &EditorLayout{
			Positie:          &V3Positie{X: 585, Y: 105},
			EdgeID:           "edge_1775852013199_8",
			SourceHandle:     "source-right",
			TargetHandle:     "target-left",
			DoelEdgeID:       "edge_1775852013199_9",
			DoelSourceHandle: "source-right",
			DoelTargetHandle: "target-left",
		},
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
			{Rolnaam: "Data", JSONRolnaam: "data", Doeltype: "B_BC_Data", Momentvoorkomen: Enkelvoudig},
		},
	}
	...
	MetaRegistry["B_BC_Data"] = TypeMeta{
		Typenaam:               "B_BC_Data",
		Klassenaam:             "Data",
		Description:            "Geversioned inhoud van B_BC.",
		Metatype:               MetatypeGegevenselement,
		GESubtype:              GESubtypeData,
		Kleur:                  "#fecaca",
		Veldnaam:               "b_bc_data",
		Padnaam:                "b_bc_data",
		Meervoud:               "b_bc_data",
		Factory:                func() Representatie { return &B_BC_Data{} },
		SliceFactory:           func() any { return &[]B_BC_Data{} },
		Tabelnaam:              "b_bc_data",
		IDKolom:                "versie",
		DBFactory:              func() Representatie { return &B_BC_Data{} },
		DBSliceFactory:         func() any { return &[]B_BC_Data{} },
		HeeftPFK:               true,
		RelatieveAutoincrement: true,
		EntiteitIDKolom:        "b_id",
		Momentvoorkomen:        Enkelvoudig,
		BovenliggendTypenaam:   "B_BC",
	}
	...
	MetaRegistry["C"] = TypeMeta{
		...
		Domein:                         "abuvwxy",
		Kleur:                          "#e298ec",
		Layout:                         &EditorLayout{Positie: &V3Positie{X: 765, Y: 75}},
		Veldnaam:                       "c",
		Padnaam:                        "cs",
		Meervoud:                       "cs",
