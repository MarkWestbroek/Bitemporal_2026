...
func init() {
	...
	// ====================================================================
	// REFERENTIELIJSTEN — Landen testmodel
	// ====================================================================
	MetaRegistry["Landenlijst"] = TypeMeta{
		Typenaam:        "Landenlijst",
		Klassenaam:      "Landenlijst",
		Description:     "Referentielijst voor landen.",
		Metatype:        MetatypeEntiteit,
		EntiteitSubtype: EntiteitSubtypeReferentielijst,
		IsMaterieel:     true,
		Kleur:           "#fef3c7",
		Veldnaam:        "landenlijst",
		Padnaam:         "landenlijsten",
		Meervoud:        "landenlijsten",
		Factory:         func() Representatie { return &Landenlijst{} },
		SliceFactory:    func() any { return &[]Landenlijst{} },
		Tabelnaam:       "landenlijst",
		IDKolom:         "id",
		DBFactory:       func() Representatie { return &Landenlijst{} },
		DBSliceFactory:  func() any { return &[]Landenlijst{} },
		HeeftPFK:        false,
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
			{Rolnaam: "LandenlijstLanden", JSONRolnaam: "landenlijst_landen", Doeltype: "Landenlijst_Land", Momentvoorkomen: Meervoudig},
			{Rolnaam: "Aanvang", JSONRolnaam: "aanvang", Doeltype: "Landenlijst_Aanvang", Momentvoorkomen: Enkelvoudig},
			{Rolnaam: "Einde", JSONRolnaam: "einde", Doeltype: "Landenlijst_Einde", Momentvoorkomen: Enkelvoudig},
		},
	}
	...
	MetaRegistry["Landenlijst_Land"] = TypeMeta{
		Typenaam:                  "Landenlijst_Land",
		Klassenaam:                "Land",
		Description:               "Koppeling van een land aan een landenlijst (referentielijst-items relatie).",
		Metatype:                  MetatypeRelatie,
		RelatieSubtype:            RelatieSubtypeReferentielijstItems,
		IsMaterieel:               false,
		GESubtype:                 GESubtypeHub,
		DataTypenaam:              "Landenlijst_Land_Data",
		Kleur:                     "#fcd34d",
		Veldnaam:                  "landenlijst_land",
		Padnaam:                   "landenlijst_landen",
		Meervoud:                  "landenlijst_landen",
		Factory:                   func() Representatie { return &Landenlijst_Land_Input{} },
		Tabelnaam:                 "landenlijst_land",
		IDKolom:                   "rel_id",
		DBFactory:                 func() Representatie { return &Landenlijst_Land{} },
		DBSliceFactory:            func() any { return &[]Landenlijst_Land{} },
		HeeftPFK:                  true,
		EntiteitIDKolom:           "landenlijst_id",
		RelatieveAutoincrement:    true,
		SecondaireEntiteitIDKolom: "land_id",
		Momentvoorkomen:           Meervoudig,
		OnderliggendeGegevenselementen: []OnderliggendGegevenselement{
			{Rolnaam: "Data", JSONRolnaam: "data", Doeltype: "Landenlijst_Land_Data", Momentvoorkomen: Enkelvoudig},
		},
	}
	...
	MetaRegistry["Landenlijst_Land_Data"] = TypeMeta{
		Typenaam:               "Landenlijst_Land_Data",
		Klassenaam:             "Data",
		Description:            "Geversioned inhoud van relatie Landenlijst_Land.",
		Metatype:               MetatypeGegevenselement,
		GESubtype:              GESubtypeData,
		Kleur:                  "#fcd34d",
		...
		Factory:                func() Representatie { return &Landenlijst_Land_Data{} },
		SliceFactory:           func() any { return &[]Landenlijst_Land_Data{} },
		Tabelnaam:              "landenlijst_land_data",
		IDKolom:                "versie",
		DBFactory:              func() Representatie { return &Landenlijst_Land_Data{} },
		DBSliceFactory:         func() any { return &[]Landenlijst_Land_Data{} },
		HeeftPFK:               true,
		RelatieveAutoincrement: true,
		EntiteitIDKolom:        "landenlijst_id",
		Momentvoorkomen:        Enkelvoudig,
		BovenliggendTypenaam:   "Landenlijst_Land",
	}
	MetaRegistry["Landenlijst_Aanvang"] = TypeMeta{
		Typenaam:               "Landenlijst_Aanvang",
		Klassenaam:             "Aanvang",
		Description:            "Aanvangsdatum van referentielijst Landenlijst.",
		Metatype:               MetatypeGegevenselement,
		GESubtype:              GESubtypeAanvang,
		Kleur:                  "#fef3c7",
		Veldnaam:               "landenlijst_aanvang",
		Padnaam:                "landenlijst_aanvang",
		Meervoud:               "landenlijst_aanvang",
		Factory:                func() Representatie { return &Landenlijst_Aanvang{} },
		SliceFactory:           func() any { return &[]Landenlijst_Aanvang{} },
		Tabelnaam:              "landenlijst_aanvang",
		IDKolom:                "versie",
		DBFactory:              func() Representatie { return &Landenlijst_Aanvang{} },
		DBSliceFactory:         func() any { return &[]Landenlijst_Aanvang{} },
		HeeftPFK:               true,
		RelatieveAutoincrement: true,
		EntiteitIDKolom:        "landenlijst_id",
		Momentvoorkomen:        Enkelvoudig,
		BovenliggendTypenaam:   "Landenlijst",
	}
	MetaRegistry["Landenlijst_Einde"] = TypeMeta{
		Typenaam:               "Landenlijst_Einde",
		Klassenaam:             "Einde",
		Description:            "Einddatum van referentielijst Landenlijst.",
		Metatype:               MetatypeGegevenselement,
		GESubtype:              GESubtypeEinde,
		Kleur:                  "#fef3c7",
		Veldnaam:               "landenlijst_einde",
		Padnaam:                "landenlijst_einde",
		Meervoud:               "landenlijst_einde",
		Factory:                func() Representatie { return &Landenlijst_Einde{} },
		SliceFactory:           func() any { return &[]Landenlijst_Einde{} },
		Tabelnaam:              "landenlijst_einde",
		IDKolom:                "versie",
		DBFactory:              func() Representatie { return &Landenlijst_Einde{} },
		DBSliceFactory:         func() any { return &[]Landenlijst_Einde{} },
		HeeftPFK:               true,
		RelatieveAutoincrement: true,
		EntiteitIDKolom:        "landenlijst_id",
		Momentvoorkomen:        Enkelvoudig,
