...
Die zitten in jouw `bitemp_register_v06` compose-project. Controleer of de gewenste services al `restart: unless-stopped` hebben in de relevante compose-bestanden, en voeg dat toe waar het ontbreekt.
