...
- **Instructiebestanden**: `copilot-instructions.md` en instruction-files per pad worden automatisch geladen (dus dat hele architectuuroverzicht van v06 wat je hebt ingesteld)
