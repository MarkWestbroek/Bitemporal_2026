...
import (
	...
	"github.com/MarkWestbroek/Bitemporal_2026/bitemporal_go_API_v05/dbsetup"
	"github.com/MarkWestbroek/Bitemporal_2026/bitemporal_go_API_v05/handlers"
	"github.com/MarkWestbroek/Bitemporal_2026/bitemporal_go_API_v05/routes"
)
...
func connectToDatabase() (*bun.DB, error) {
	...
	if dsn == "" {
		...
		dsn = "postgres://postgres:1234@localhost:5432/bitemp_go_db_v05?sslmode=disable"
	}
